...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-an1mo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-an1mo.containers.anotherwebservice.com/
...
```
git clone git@github.com:hharzer/container-an1mo.git
cd container-an1mo
```
